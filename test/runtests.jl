...
# println("Speed test: 100 nontrivial intersections in 3D ... ", t3D_nontrivial/nreps, " s per intersection")
#
# t4D_nontrivial = @elapsed speed_test_nontrivial(4, nreps)
#
# println("Speed test: 100 nontrivial intersections in 4D ... ", t4D_nontrivial/nreps, " s per intersection")
#
# t5D_nontrivial = @elapsed speed_test_nontrivial(5, nreps)
# println("Speed test: 100 nontrivial intersections in 5D ... ", t5D_nontrivial/nreps, " s per intersection")
#
# t3D_shared = @elapsed speed_test_sharing(3, nreps)
# println("Speed test: 100 shared intersections in 3D ... ", t3D_shared/nreps, " s per intersection")
#
# t4D_shared = @elapsed speed_test_sharing(4, nreps)
# println("Speed test: 100 shared intersections in 4D ... ", t4D_shared/nreps, " s per intersection")
#
# t5D_shared = @elapsed speed_test_sharing(5, nreps)
# println("Speed test: 100 shared intersections in 5D ... ", t5D_shared/nreps, " s per intersection")
