function SharingAFace(simplex2, convexexp1in2, ordered_vertices1, ordered_vertices2)
    IntVol = 0
    n = size(simplex2, 1)

    indexextra1 = ordered_vertices1[1, n + 1][1]
    indexextra2 = ordered_vertices2[1, n + 1][1]
    convex_exp_lastvertof1 = convexexp1in2[:, indexextra1].'

    extra_convex_coeff = convex_exp_lastvertof1[indexextra2]

    shared_vert_indicesin2 = ordered_vertices2[1, 1:n].'
